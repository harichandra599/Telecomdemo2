...
import com.Telecom.customListner.Listner;
import com.Telecom.excelReader.ExcelReader;
...
static
{
	Calendar calendar=Calendar.getInstance();
  	...
  	extent=new ExtentReports(System.getProperty("user.dir")+"//src//main//java//com//Telecom//reports//Test_Execution_Report-"+formater.format(calendar.getTime())+".html",false);
...
{
	File config = new File(System.getProperty("user.dir") + "//src//main//java//com//Telecom//config//config.properties");
...
public String[][] getData(String excelName, String sheetName) throws BiffException, IOException
{
	...
	String excellocation = System.getProperty("user.dir")+"//src//main//java//com//Telecom//data//"+excelName;
